...
CREATE TABLE IF NOT EXISTS tbl_book_works (
    book_work_id    INTEGER PRIMARY KEY AUTOINCREMENT,
    title           TEXT NOT NULL,
    title_sort      TEXT,
    star_rating     INTEGER,
    review          TEXT,
    ...
    FOREIGN KEY (read_status_id) REFERENCES lkup_book_read_statuses(read_status_id),
...
CREATE TABLE IF NOT EXISTS xref_book_work_authors (
    book_work_id INTEGER NOT NULL,
    author_id    INTEGER NOT NULL,
    author_order INTEGER NOT NULL DEFAULT 1,

    FOREIGN KEY (book_work_id) REFERENCES tbl_book_works(book_work_id),
    FOREIGN KEY (author_id) REFERENCES lkup_book_authors(author_id),
    UNIQUE (book_work_id, author_id)
);
...
CREATE TABLE IF NOT EXISTS xref_book_work_series (
    book_work_id  INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS xref_book_work_genres (
    book_work_id       INTEGER NOT NULL,
    top_level_genre_id INTEGER NOT NULL,
    ...
    UNIQUE (book_work_id, top_level_genre_id, sub_genre_id)
);

CREATE TABLE IF NOT EXISTS tbl_book_tags (
...
CREATE TABLE IF NOT EXISTS xref_book_work_tags (
    book_work_id INTEGER NOT NULL,
    tag_id       INTEGER NOT NULL,

    FOREIGN KEY (book_work_id) REFERENCES tbl_book_works(book_work_id),
    FOREIGN KEY (tag_id) REFERENCES tbl_book_tags(tag_id),
    UNIQUE (book_work_id, tag_id)
);


-- ============================================================
-- BOOKS - VERSION / ITEM LEVEL TABLES
-- ============================================================

CREATE TABLE IF NOT EXISTS lkup_book_sources (
...
CREATE TABLE IF NOT EXISTS tbl_book_details (
    ...
    FOREIGN KEY (item_id) REFERENCES tbl_items(item_id),
    FOREIGN KEY (book_work_id) REFERENCES tbl_book_works(book_work_id),
    FOREIGN KEY (source_id) REFERENCES lkup_book_sources(source_id)
);